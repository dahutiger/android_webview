...
//    private static int sGravity = -1;
     ...
     * @return
     */
    public static View showIconShort(@DrawableRes final int iconId, @StringRes final int resId) {
        return showIconShort(iconId, ResourcesUtil.getString(resId));
    }
     ...
     * @return
     */
    public static View showIconShort(@DrawableRes final int iconId, final String message) {
        final View view = getView(R.layout.toast_custom);
        final ImageView iconIv = view.findViewById(R.id.iv_icon);
     ...
     * @return
     */
    public static View showIconLong(@DrawableRes final int iconId, @StringRes final int resId) {
        return showIconShort(iconId, ResourcesUtil.getString(resId));
    }
     ...
     * @return
     */
    public static View showIconLong(@DrawableRes final int iconId, final String message) {
        final View view = getView(R.layout.toast_custom);
        final ImageView iconIv = view.findViewById(R.id.iv_icon);
        iconIv.setImageResource(iconId);
        iconIv.setVisibility(View.VISIBLE);
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(ResourcesUtil.getString(resId), duration);
    }
    
    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(ResourcesUtil.getString(resId), args), duration);
    }
...
//            public void run() {
//                cancel();
//                sToast = Toast.makeText(AppUtil.getContext(), text, duration);
...
//        });
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(AppUtil.getContext());
                sToast.setView(view);
